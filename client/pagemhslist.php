    ...
    <script>
        ...
        jsonData.onload = function(){
            ...
            hasil += "          <th scope='col'><a class='badge bg-primary' href='index.php'>Tambah Data</a></th>"
            hasil += "      </tr>"
            hasil += "  </thead>"
            hasil += "  <tbody>"
            ...
            for(i=0; i<myData.length; i++){
                ...
                hasil += "     <td><a class='badge bg-success' href='index.php?='>EDIT</a><a class='badge bg-danger' href='formhapusmhs.php?nim='>HAPUS</a></td>"
                hasil += "</tr>"
